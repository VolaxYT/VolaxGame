...
public class MainMenuScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.fontMainMenu.draw(game.batch, "Press space to start !", game.width / 2 - 217, game.height / 3);
        game.fontMainMenu.draw(game.batch, "Press B to open the shop !", game.width / 2 - 260, game.height / 3 - 80);
